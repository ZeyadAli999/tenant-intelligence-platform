...
TENANT_CODE="${TENANT_CODE:-demo-tenant}"
ADMIN_EMAIL="${ADMIN_EMAIL:-admin@demo.example}"
ADMIN_FULL_NAME="${ADMIN_FULL_NAME:-Demo Administrator}"
...
echo "Password:              (The password entered during setup)"
echo "======================================================================"
